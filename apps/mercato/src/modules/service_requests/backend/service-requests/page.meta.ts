...
const wrenchIcon = React.createElement(
  'svg',
...
export const metadata = {
  requireAuth: true,
  requireFeatures: ['service_requests.view'],
  pageTitle: 'Zgłoszenia serwisowe',
  pageTitleKey: 'service_requests.page.title',
  pageGroup: 'Serwis',
  pageGroupKey: 'service_requests.nav.group',
  pageOrder: 200,
  icon: wrenchIcon,
  breadcrumb: [
    { label: 'Zgłoszenia serwisowe', labelKey: 'service_requests.page.title' },
  ],
}
